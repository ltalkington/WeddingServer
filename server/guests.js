module.exports = (function () {
  ...
  //     mysql.pool.query(
  //       "SELECT bsg_people.character_id as id, fname, lname, bsg_planets.name AS homeworld, age FROM bsg_people INNER JOIN bsg_planets ON homeworld = bsg_planets.planet_id",
  //       function (error, results, fields) {
  //         if (error) {
  //           res.write(JSON.stringify(error));
  //           res.end();
  ...
  router.post("/", function (req, res) {
    ...
    console.log(req.body);
    var mysql = req.app.get("mysql");
    var sql = "INSERT INTO Guests (fname, lname, age) VALUES (?,?,?,?)";
    var inserts = [
      req.body.firstName,
      req.body.lastName,
      req.body.group,
